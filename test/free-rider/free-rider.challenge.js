...
describe("[Challenge] Free Rider", function () {
  ...
  it("Execution", async function () {
    ...
    await (await ethers.getContractFactory("FreeRiderAttacker", player))
      .deploy(token.address, weth.address, nft.address, uniswapPair.address, marketplace.address, devsContract.address)
      .then(async (attacker) => {
